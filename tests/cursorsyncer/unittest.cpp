...
TEST(CursorSync, MoveRightOnEdge){
    initscr();      
...
TEST(CursorSync, MoveLeftOnStart){
    initscr();      
...
TEST(CursorSync, MoveStartlnUpOnTop){
    initscr();  
...
TEST(CursorSync, MoveStartlnDownOnBottom){
    initscr();      
